...
const I18N = {
  ko: {
    ...
    // scope text
    scopeAll6: '분석 대상 6개 연도 (2015–18·24–25)',
    scopeAll7: '분석 대상 7개 연도 (2015–18·24–26)',
    scopeAll: '분석 대상 6개 연도 (2015–18·24–25)',
    ...
    ytExcBadge: '제외', ytCargoBadge: '화물 편중', btnPrint: '🖨 인쇄',
    btn2026on: '📆 2026 포함',
    btn2026off: '📆 2026 제외', jpyCfgLabel: '1엔 =', jpyCfgUnit: '원', unitKrwShort: '원',
    ytVoyUnit: ' 명',
    ytLossUnit: '원',
    ytFcLossUnit: '원',
    ...
    noteYearBody: '초과 비율 = 260명 초과 항차 ÷ 전체 항차. 손실률 = 초과 인원 ÷ 여객 합계. <b>합계·연평균 행은 분석 대상 6개 연도 (2015–2018·2024–2025) 기준</b>이며, 2019·2023년(코로나·노재팬 영향권)은 참고 행으로만 표시합니다. 코로나 기간(2020–2022)은 모든 집계에서 제외됩니다. <b>2026년 행은 예상 수요 173,825명</b>을 2025년 항차별 여객 분포에 비례 적용해 추정한 값이며, 실적이 아니므로 합계·평균에 포함하지 않았습니다.',
    ...
    ctabTrend: '여객수 추이', ctabBars: '260명 초과', ctabHeat: '히트맵',
    ...
    sectLoss: '추정 손해액 분석',
    labB7: '공동계산 손해 (1/2)', labB8: '부관 방향 손해 (66.62%)', labB9: '관부 방향 손해 (33.38%)',
    b7note: '추정 손해액 ÷ 2 (균등 분담 기준)',
    b8note: '운임비중 66.62% 배분 시', b9note: '운임비중 33.38% 배분 시',
    diffMore: '균등분담 대비 초과 부담', diffLess: '균등분담 대비 절감',
    ddNearGroup: '── 코로나·노재팬 영향권 ──',
    hmNearGrp: '코로나·노재팬 영향권',
    hmNear2019: '2019 ⚑ 노재팬(7월~)·코로나(12월~)',
    hmNear2023: '2023 ⚑ 코로나 엔데믹(~5월, 선언 전)',
    hmExcl: '계산 제외',
    cfgTitle: '⚙ 운임 설정',
    cfgL1: '부관 운임비중', cfgL2: '관부',
    cfgL3: '부관 1인당 운임', cfgL4: '관부 1인당 운임',
    cfgUnit: '원',
    b8pct: '부관 방향 ', b9pct: '관부 방향 ',
    lvSum: '합계', lvAvg: '연평균',
    ytNearGrp: '─ 코로나·노재팬 영향권 (합계·평균 포함) ─',
    capCfgTitle: '⚙ 초과 기준 인원 설정',
    capCfgLabel: '최대 인원', capCfgUnit: '명',
    cpBtn260: '260명', cpBtn460: '460명', cpBtn555: '555명 (최대)',
  },
  ja: {
    ...
    ytExcBadge: '除外', ytCargoBadge: '貨物偏重', btnPrint: '🖨 印刷',
    btn2026on: '📆 2026込み',
    btn2026off: '📆 2026除外', jpyCfgLabel: '1円 =', jpyCfgUnit: '円', unitKrwShort: '円',
    ytVoyUnit: ' 名',
    ytLossUnit: '円',
    ytFcLossUnit: '円',
    ...
    ctabTrend: '旅客数推移', ctabBars: '260名超過', ctabHeat: 'ヒートマップ',
    ...
    sectLoss: '推定損失 分析',
    labB7: '共同計算 損失 (1/2)', labB8: '釜関方向 損失 (66.62%)', labB9: '関釜方向 損失 (33.38%)',
    b7note: '推定損失 ÷ 2 (均等分担基準)',
    b8note: '運賃比率66.62%配分時', b9note: '運賃比率33.38%配分時',
    diffMore: '均等分担比 超過負担', diffLess: '均等分担比 節減',
    noteDirFare: '旅客1名当たり運賃',
    ddNearGroup: '── コロナ·不買運動 影響下 ──',
    hmNearGrp: 'コロナ·不買運動 影響下',
    hmNear2019: '2019 ⚑ 不買(7月~)·コロナ(12月~)',
    hmNear2023: '2023 ⚑ コロナエンデミック(~5月、宣言前)',
    hmExcl: '計算除外',
    cfgTitle: '⚙ 運賃設定',
    cfgL1: '釜関 運賃比率', cfgL2: '関釜',
    cfgL3: '釜関 1人当運賃', cfgL4: '関釜 1人当運賃',
    cfgUnit: '円',
    b8pct: '釜関方向 ', b9pct: '関釜方向 ',
    lvSum: '合計', lvAvg: '年平均',
    ytNearGrp: '─ コロナ·不買運動 影響下 (合計·平均に含む) ─',
    scopeAll6: '分析対象6年間 (2015–18·24–25)',
    scopeAll7: '分析対象7年間 (2015–18·24–26)',
    capCfgTitle: '⚙ 超過基準人員設定',
    capCfgLabel: '最大人員', capCfgUnit: '名',
    cpBtn260: '260名', cpBtn460: '460名', cpBtn555: '555名 (最大)',
  }
};
